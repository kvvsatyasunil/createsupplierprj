		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Approve Supplier Creation Task",
									"targetURL": "#comtsmdguiapprovesupplierui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtsmdguiapprovesupplierui-display": {
								"semanticObject": "comtsmdguiapprovesupplierui",
								"action": "display",
								"description": "Approve Supplier Creation Task",
								"title": "Approve Supplier Creation Task",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ts.mdg.ui.approvesupplierui",
									"url": sap.ui.require.toUrl("com/ts/mdg/ui/approvesupplierui")
								}
							}
						}
					}
